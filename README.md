...
3. Use http://localhost:3000/audio?text={AnkiField} as field in anki with Generate Batch Audio OR "<audio autoplay controls src="http://localhost:3000/audio?text={{Katakana}}"></audio>" as an example in your card to save disk space. To create a keybinding that resets audio one can use [this](replay.js)
